// Deciding when input should end the saver (spec 9.2).
//
...
#ifndef NUKE_SAVER_INPUT_WATCHER_H
#define NUKE_SAVER_INPUT_WATCHER_H
...
public:
    ...
    // Spec 9.2 wants a small dead zone so that pointer jitter does not dismiss the saver.
